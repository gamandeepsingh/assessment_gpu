...
const Marquee: React.FC = () => {
  ...
  return (
    <div className="relative bg-black overflow-hidden py-3 rounded-lg">
      ...
      <div className="pointer-events-none absolute left-0 top-0 h-full w-48 bg-gradient-to-r from-[#0f0f0f] to-transparent"></div>

      {/* Right gradient overlay */}
      <div className="pointer-events-none absolute right-0 top-0 h-full w-48 bg-gradient-to-l from-[#0f0f0f] to-transparent"></div>
    </div>
  );
};
